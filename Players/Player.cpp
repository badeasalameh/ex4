...
{
    if(p1.m_level > p2.m_level)
    {
        return true; // Return true if p1 is greater than p2
    }
    else if(p1.m_level == p2.m_level)
    {
        if(p1.m_coins > p2.m_coins)
        {
            return true; // Return true if p1 is greater than p2
        }
        else if(p1.m_coins == p2.m_coins)
        {
            return p1.m_name < p2.m_name; // Return true if p1's name comes before p2's name lexicographically
        }
    }
