...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//CREATOR FUNCTIONS:
void createAndInsertCardWithoutGang(queue<string> queue , std::queue<unique_ptr<Card>> m_cards)
{
    while(!queue.empty())
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Mtmchkin::Mtmchkin(const string& deckPath, const string& playersPath) : m_numOfWinners(0) , m_numOfLosers(0) {
